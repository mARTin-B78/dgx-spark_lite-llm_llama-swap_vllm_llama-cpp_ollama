#!/bin/bash
# =============================================================================
# test-model.sh — Smoke-test a single llama-swap model
#
# Usage: ./test-model.sh <model_name>
# =============================================================================
...
CSV_FILE="$RESULTS_DIR/results_${MODEL}_${TIMESTAMP}.csv"
LOG_FILE="$RESULTS_DIR/results_${MODEL}_${TIMESTAMP}.log"
...
unload_all() {
    # Disabled so we can test speed without cold load.
    true
}
...
log ""
log "${BOLD}============================================================${NC}"
log "${BOLD}  llama-swap Single Model Test${NC}"
log "${BOLD}============================================================${NC}"
...
log "${BOLD}[1/1] $MODEL${NC}"
log "  Unloading previous models..."
# unload_all
...
log "${BOLD}  SUMMARY${NC}"
log "${BOLD}============================================================${NC}"
log "  ${GREEN}Passed:${NC} $PASS / 1"
log "  ${RED}Failed:${NC} $FAIL / 1"
